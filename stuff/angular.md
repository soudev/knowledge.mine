...
* [[GitHub] rangle / augury](https://github.com/rangle/augury) - Angular Debugging and Visualization Tools
...
* [Debugging Angular Using Visual Studio Code (VSCode) | C# Corner](http://www.c-sharpcorner.com/article/debugging-angular-using-visual-studio-code-vscode/) - 2017/05/22
...
* [Angular with Web Workers: Step by step | Enrique oriol – Medium](https://medium.com/@enriqueoriol/angular-with-web-workers-step-by-step-dc11d5872135) - 2017/04/06

  * [[GitHub] kaikcreator / angular-cli-web-worker](https://github.com/kaikcreator/angular-cli-web-worker) - example on how to configure web workers in angular CLI
...
* [Providing data via Angular 2 Services | Arroyo Labs](http://blog.arroyolabs.com/2016/10/providing-data-via-angular-2-services/) - 2016/10/10
...
* TypeScript
  ...
  * Angular Class
    ...
    * [[GitHub] AngularClass / angular2-webpack-starter](https://github.com/AngularClass/angular2-webpack-starter) - An Angular 2 Webpack Starter kit featuring Angular 2 (Router, Http, Forms, Services, Tests, E2E), Karma, Protractor, Jasmine, TypeScript, and Webpack by @AngularClass
      ...
      * [[GitHub] ghillert / angular2-webpack-starter-bootstrap](https://github.com/ghillert/angular2-webpack-starter-bootstrap) - An Angular 2 Webpack Starter kit (WITH BOOTSTRAP SUPPORT)
